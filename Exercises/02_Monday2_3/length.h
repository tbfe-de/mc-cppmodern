...
namespace my {
	...
	public:
		...
		static constexpr length mm(double v)   { return m(v/1000); }
		static constexpr length cm(double v)   { return m(v/100); }
		static constexpr length inch(double v) { return cm(2.54*v); }
		static constexpr length km(double v)   { return m(v*1000); }
